...
- create_short_url( url: {"url":str, "ttl":int?} ) -> {"short_url": str}  
URI : /shorten  
Method : POST
- redirect_url(short_url: str) -> Redirect / HTTPException  
URI : /{short_url}  
Method : GET
- get_stats(short_url: str) -> { "origin_url": str, "short_url": str, "click_cnt": int }  
URI : /stats/{short_url}  
Method : GET
- swagger API Doc  
URI : /docs